...
export class Task {
  ...
  async run() {
    ...
    try {
      ...
      if (!exist) {
        csv += `\uFEFF
      航空公司,航班编号,机型,起飞城市,起飞机场,计划起飞时间,是否中转/经停,,,,,,,,,,,,,,,,,,,,,,,,到达机场,到达城市,计划到达时间,总飞行时长,经济票价（元）,总到达准点率
,,,,,,第一航段到达机场,第一航段到达时间,第一航段飞行时间,第一航段准点率,中转停留时间,经停机场,第二航段航空公司,第二航段航班编号,第二航段起飞机场,第二航段起飞时间,第二航段飞行时间,第二航段准点率,第二航段中转停留时间,第二航段经停机场,第二航段到达机场,第二航段到达时间,第三航段航空公司,第三航段航班编号,第三航段起飞机场,第三航段起飞时间,第三航段飞行时间,第三航段准点率,第三航段到达机场,第三航段到达时间`
      }
